...
function godocs_generateTOC() {
  ...
  split_index = (toc_items.length / 2);
  var has_two_columns = true;
  if (split_index < 1) {
    split_index = 1;
  }
  if (split_index < 5) {
...
function godocs_addTopLinks() {
  ...
  godocs_addTopLinksPerTag('h2');
  godocs_addTopLinksPerTag('h3');
  godocs_addTopLinksPerTag('h4');
}

function godocs_addTopLinksPerTag(tag) {
